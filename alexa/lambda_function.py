...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Bem-vindo a Babilônia. Como posso te ajudar?"
...
class AboutIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "Babilônia é a startup que está revolucionando a agricultura urbana"
...
class ManagementIntentHandler(AbstractRequestHandler):
    """Handler for Management Intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("ManagementIntent")(handler_input)
...
class CatchAllExceptionHandler(AbstractExceptionHandler):
    ...
    def handle(self, handler_input, exception):
        ...
        speak_output = "Me desculpe. Não entendi seu pedido."
...
sb.add_request_handler(ManagementIntentHandler())
