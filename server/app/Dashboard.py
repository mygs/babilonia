...
class Dashboard:
    ...
    def raspberrypi(self):
        ...
        time_end = dt.datetime.now()
        elapsedTime = time_end - time_start
        self.logger.debug("[Dashboard > Rasp] took %s secs",elapsedTime.total_seconds())
    ...
    def farm(self, modules):
        ...
        time_end = dt.datetime.now()
        elapsedTime = time_end - time_start
        self.logger.debug("[Dashboard > Farm] took %s secs",elapsedTime.total_seconds())
        return data
    ...
    def nodes(self, latest_beat):
        ...
        time_end = dt.datetime.now()
        elapsedTime = time_end - time_start
        self.logger.debug("[Dashboard > Nodes] took %s secs",elapsedTime.total_seconds())
        return data
    ...
    def __cpu_temperature(self):
        ...
        response = int((int(CPUTemp)/1000.0))

        time_end = dt.datetime.now()
        elapsedTime = time_end - time_start
        self.logger.debug("[Dashboard > CPU Temp] took %s secs",elapsedTime.total_seconds())
        return response
    ...
    def __memory_usage(self):
        ...
        time_end = dt.datetime.now()
        elapsedTime = time_end - time_start
        self.logger.debug("[Dashboard > Mem Usage] took %s secs",elapsedTime.total_seconds())
        return mem_usage
    ...
    def __disk(self):
        ...
        time_end = dt.datetime.now()
        elapsedTime = time_end - time_start
        self.logger.debug("[Dashboard > Disk] took %s secs",elapsedTime.total_seconds())
        return response
    ...
    def __processes(self):
        ...
        time_end = dt.datetime.now()
        elapsedTime = time_end - time_start
        self.logger.debug("[Dashboard > System Load] took %s secs",elapsedTime.total_seconds())
        return response
